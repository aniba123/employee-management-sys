...
const EmployeeProfile = () => {
  ...
  const handleSearch = () => {
    ...
    setSearchResult(foundEmployee || null);
    setHasSearched(true);
  };
      ...
      {hasSearched && (
        <ResultsContainer>
          {searchResult ? (
            <EmployeeCard>
              <EmployeeHeader>
                <EmployeeName>{searchResult.name}</EmployeeName>
                <EmployeePosition>{searchResult.position}</EmployeePosition>
              </EmployeeHeader>
              
              <EmployeeDetails>
                <DetailRow>
                  <DetailLabel>Department:</DetailLabel>
                  <DetailValue>{searchResult.department}</DetailValue>
                </DetailRow>
                <DetailRow>
                  <DetailLabel>Email:</DetailLabel>
                  <DetailValue>{searchResult.email}</DetailValue>
                </DetailRow>
                <DetailRow>
                  <DetailLabel>Phone:</DetailLabel>
                  <DetailValue>{searchResult.phone}</DetailValue>
                </DetailRow>
                <DetailRow>
                  <DetailLabel>Employee ID:</DetailLabel>
                  <DetailValue>{searchResult.id}</DetailValue>
                </DetailRow>
              </EmployeeDetails>
            </EmployeeCard>
          ) : (
            <NotFoundMessage>No employee found.</NotFoundMessage>
          )}
        </ResultsContainer>
      )}
    </Container>
...
// Styled Components (remain exactly the same as previous version)
